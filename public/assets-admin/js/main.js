...
(function () {
    var sidebarStorageKey = "admin.sidebarMini";
    var themeStorageKey = "admin.colorTheme";
    ...
    onReady(function () {
        ...
        // Initialize user profile values in UI. Provide a window.admin object to override defaults.
        function initUserProfile() {
            var user = window.admin || {
                name: "Admin",
            ...
            var sidebarWorkspaceEl = document.querySelector(
                ".sidebar-user small",
            );
            var sidebarAvatar = document.querySelector(
