            ...
            <section class="row g-3">
                <div class="col-12 col-xl-4">
                    <div class="panel h-100 text-center profile-card">
                        <div class="profile-cover"><img src="/assets-admin/images/dashboard.png"
                                alt="admin dashboard preview"></div>
                        <img class="avatar-img avatar-xl profile-photo" src="/assets-admin/images/avatar.jpg"
                            alt="Admin">
                        ...
                        <div class="d-flex justify-content-center gap-2"><span
                                class="badge text-bg-success">Admin</span><span
                    ...
                    <form class="panel needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label" for="profileName">Name</label><input
                                    class="form-control" id="profileName" type="text" value="Admin" required>
