...
@section('content')
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section>
                <div>
                    <form action="{{ route('createProduct') }}" method="post" enctype="multipart/form-data" class="panel needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input name="name" class="form-control" type="text" required id="productName">
                                <div class="invalid-feedback">Product name is required.</div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="productCategory">Product Category</label>
                                <input name="category" class="form-control" type="text" required id="productCategory">
                                <div class="invalid-feedback">Product Category is required.</div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="productBrand">Product Brand</label>
                                <input name="brand" class="form-control" type="text" min="1" required id="productBrand">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="description" class="form-control" type="text" required id="productDescription">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="image" class="form-control" type="file" required id="productImage">
                                <div class="invalid-feedback">Product Image is required.</div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label" for="productPrice">Product Price</label>
                                <input name="price" class="form-control" type="number" step="0.01" min="0" required id="productPrice">
                            ...
                            <div class="col-md-3">
                                ...
                                <input name="discount" class="form-control" type="number" step="0.01" min="0" max="100" required id="productDiscount">
                                <div class="invalid-feedback">Product Discount is required.</div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label" for="productStock">Product Stock</label>
                                <input name="stock" class="form-control" type="number" min="0" required id="productStock">
                            ...
                            <div class="col-md-3">
                                ...
                                <input name="launch_date" class="form-control" type="date" required id="productLaunchDate">
